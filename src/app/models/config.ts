...
const typeMap: any = {
  Config: o(
    [
      { json: 'basePath', js: 'basePath', typ: '' },
      { json: 'rabbitPath', js: 'rabbitPath', typ: '' },
      { json: 'useRdpCredentials', js: 'useRdpCredentials', typ: true },
      { json: 'startRdp', js: 'startRdp', typ: true },
    ],
    false
  ),
};
